...
public:
    struct Api
    {
        ...
        ph_color_get_last_error_message_fn get_last_error_message;
        ph_color_get_error_message_fn get_error_message;
        ...
        ph_color_debayer_and_white_balance_fn debayer_and_white_balance;
        ...
        ph_color_buffer_alloc_fn buffer_alloc;
        ph_color_buffer_free_fn buffer_free;
    };
